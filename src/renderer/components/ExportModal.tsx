    ...
    <div className="bg-brand-surface/90 backdrop-blur-md border border-brand-border p-4 rounded-2xl flex flex-col gap-6 shadow-2xl text-brand-text min-w-[320px]">
      ...
      <div className="flex flex-col gap-3">
        <button
          ...
          className={`flex items-center gap-4 bg-brand-bg/50 p-4 rounded-xl border border-brand-border/30 transition-all group text-left ${isExportingGif ? 'opacity-50 cursor-not-allowed' : 'hover:border-brand-primary/50 hover:bg-brand-primary/5'
            }`}
        >
        ...
        <button
          ...
          disabled={isExportingGif || isExportingBash}
          className={`flex items-center gap-4 bg-brand-bg/50 p-4 rounded-xl border border-brand-border/30 transition-all group text-left ${isExportingBash ? 'opacity-50 cursor-not-allowed' : 'hover:border-brand-primary/50 hover:bg-brand-primary/5'
            }`}
        >
          <div className="w-10 h-10 bg-brand-primary/10 rounded-lg flex items-center justify-center text-brand-primary group-hover:scale-110 transition-transform shrink-0">
